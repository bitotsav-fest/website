...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-br from-[#0A0118] via-[#2D1E0F] to-[#1A0B2E] text-[#F6F1E2] py-12 px-6 md:px-20 border-t border-[#EFCA4E]/20 z-10">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="md:w-1/3 text-center md:text-left space-y-4">
            <h2 className="text-xl font-bold flex items-center gap-3 text-[#EFCA4E]">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#EFCA4E] to-[#F6F1E2]">Birla Institute of Technology, Mesra</span>
            </h2>
          ...
          <div className="text-center md:text-left bg-[#EFCA4E]/5 p-6 rounded-2xl backdrop-blur-sm border border-[#EFCA4E]/10">
            <h3 className="text-lg font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#EFCA4E] to-[#F6F1E2]">Technical Queries</h3>
            <div className="space-y-3">
              <p className="text-sm">
                <span className="text-[#EFCA4E]/80">Shaswat Raj:</span>{" "}
                <a href="tel:+919508846600" className="hover:text-[#EFCA4E] transition-colors">
                  9508846600
                </a>
              </p>
              <p className="text-sm">
                <span className="text-[#EFCA4E]/80">Mrityunjay Raj:</span>{" "}
                <a href="https://wa.me/919471828932" className="hover:text-[#EFCA4E] transition-colors">
                  9471828932 <span className="text-[9px]">(WhatsApp)</span>
                </a>
              </p>
              <p className="text-sm">
                <span className="text-[#EFCA4E]/80">Abhinav Kumar Choudhary:</span>{" "}
                <a href="tel:+919939110848" className="hover:text-[#EFCA4E] transition-colors">
                  9939110848
                </a>
              </p>
            </div>
          ...
          {/* Virtual Helpdesk */}
          <div className="text-center md:text-left bg-[#EFCA4E]/5 p-6 rounded-2xl backdrop-blur-sm border border-[#EFCA4E]/10">
            <h3 className="text-lg font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#EFCA4E] to-[#F6F1E2]">Need Assistance?</h3>
        ...
        <div className="mt-12 pt-6 border-t border-[#EFCA4E]/10">
          <div className="text-center text-sm text-[#F6F1E2]/60">© {new Date().getFullYear()} BIT Mesra. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
