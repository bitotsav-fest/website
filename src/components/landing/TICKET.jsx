  ...
  React.useEffect(() => {
    animate(
      [
        ...
        ["#cultural", { opacity: 1 }, { duration: 0.3 }],
        [
          "#pointer",
          { left: 50, top: 102 },
          { at: "+0.5", duration: 0.5, ease: "easeInOut" },
        ],
        ["#cultural", { opacity: 0.4 }, { at: "-0.3", duration: 0.1 }],
        ["#technical", { opacity: 1 }, { duration: 0.3 }],
        [
          "#pointer",
          { left: 224, top: 170 },
          { at: "+0.5", duration: 0.5, ease: "easeInOut" },
        ],
        ["#technical", { opacity: 0.4 }, { at: "-0.3", duration: 0.1 }],
        ["#sports", { opacity: 1 }, { duration: 0.3 }],
        [
          "#pointer",
          { left: 88, top: 198 },
          { at: "+0.5", duration: 0.5, ease: "easeInOut" },
        ],
        ["#sports", { opacity: 0.4 }, { at: "-0.3", duration: 0.1 }],
        ["#workshops", { opacity: 1 }, { duration: 0.3 }],
        [
          "#pointer",
          { left: 200, top: 60 },
          { at: "+0.5", duration: 0.5, ease: "easeInOut" },
        ],
        ["#workshops", { opacity: 0.5 }, { at: "-0.3", duration: 0.1 }],
      ],
      {
                ...
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Link
                        href={"https://cal.com/bitotsav/event"}
                        target="_blank"
                      >
                        <Button>Book a call</Button>
                      </Link>
                      <Link
                        href="mailto:contact@bitotsav.in"
                        target="_blank"
                        className={cn(
                          buttonVariants({
                            variant: "outline",
