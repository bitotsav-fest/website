    ...
    <nav className="fixed top-0 w-full z-50 bg-gradient-to-r from-[#2D1E0F]/90 via-[#1A0B2E]/90 to-[#2D1E0F]/90 backdrop-blur-lg border-b border-[#EFCA4E]/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            {items.map((item) => {
              ...
              return (
                <div
                  ...
                  className={`relative flex items-center space-x-1 text-sm font-medium transition-all duration-300 hover:text-[#EFCA4E] cursor-pointer ${
          ...
          <button onClick={() => setIsOpen(!isOpen)} className="md:hidden p-2 rounded-md text-[#F6F1E2] hover:bg-[#EFCA4E]/10 transition-colors duration-300">
        ...
        {isOpen && (
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="md:hidden py-4">
