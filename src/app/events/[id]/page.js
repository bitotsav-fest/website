...
export default function EventDetailPage() {
  ...
  const handleRegister = () => {
    ...
    toast((t) => (
      <div>
        <p>Are you sure you want to register for the event "{eventName}"?</p>
        <div className="flex justify-end gap-2 mt-2">
          <button className="px-4 py-2 bg-[#ff000033] text-white rounded" onClick={() => toast.dismiss(t.id)}>
            Cancel
          </button>
          <button
    ...
    const proceedWithRegistration = () => {
      const finalConfirmation = window.confirm(`This is your final confirmation to register for "${eventName}". Do you want to proceed?`)
