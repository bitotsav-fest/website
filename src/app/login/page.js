    ...
    <div className='min-h-screen relative overflow-hidden bg-gradient-to-br from-[#1A1A1A] via-[#2A1B3D] to-[#382952] flex items-center justify-center p-4'>
      ...
      >
        ...
        <motion.button
          ...
          className='w-full flex items-center justify-center gap-3 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 text-white py-4 px-6 rounded-xl transition-all duration-300 border border-amber-500/20 hover:border-amber-500/40 hover:shadow-lg hover:shadow-amber-500/20'
        >
        ...
        <motion.div
          ...
          className='text-center mt-6 p-4 rounded-xl bg-gradient-to-r from-amber-500/5 to-yellow-500/5 border border-amber-500/10'
        >
          ...
          <span className='text-amber-100/60 ml-1'>
            If you don&apos;t own a BIT webmail then,{" "}
