...
export default function NonBitPage() {
  return (
    <div className="min-h-screen mt-16 bg-gradient-to-br from-black via-gray-900 to-black p-8">
      ...
      >
        <h1 className="text-4xl font-bold text-gold mb-6 text-center">Welcome to Bitotsav 2024</h1>
        ...
        <div className="space-y-6">
          <section className="bg-black/30 p-6 rounded-lg border border-gold/20">
            ...
            <p className="text-gray-300 mb-4">
              Experience the grandeur of Bitotsav 2024! As a non-BIT Mesra student, you can participate in this spectacular event by purchasing your tickets below.
            </p>
