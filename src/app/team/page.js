        ...
        {!Loading && teamCode && (
          ...
          >
            <h4 className="text-2xl font-semibold text-[#EFCA4E]">
              Your Team Name : <span className="text-2xl font-semibold text-white decoration-2 ">{teamData?.teamName}</span>
              <br />
              <span className="text-2xl font-semibold text-[#EFCA4E] decoration-2 ">{teamData?.rollNumber}</span>
            </h4>
  ...
  <span className="text-yellow-400/80 text-xs">(Note: Team modifications will only be considered in extreme cases, so please create your team carefully)</span>
          ...
          <div className="text-[#F6F1E2]/80 space-y-3">
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Same Institution Requirement</strong>: All team members must be from the same institution. No cross-institution teams.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                ...
                <ul className="list-disc pl-6">
                  ...
                  <li>
                    <strong>Restriction</strong>: Non-BIT students can only join day events, not night events.
                  </li>
                </ul>
              </li>
            </ul>

            <p className="text-[#F6F1E2]/60 text-center">These rules ensure fair, secure, and institutionally compliant participation.</p>
          </div>
        </div>
      </motion.div>
    </div>
