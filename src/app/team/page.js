      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative text-center space-y-6 py-8">
          ...
          <h1 className="relative">
            <span className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#EFCA4E] via-[#F6F1E2] to-[#EFCA4E] animate-gradient-x">
              Team Registration
            </span>
          ...
          {!Loading && !teamCode && (
            <motion.p 
              ...
              className="text-[#F6F1E2]/70 text-xl font-light tracking-wide"
            >
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                <h4 className="text-4xl font-bold bg-gradient-to-r from-[#EFCA4E] to-white bg-clip-text text-transparent mb-4">
                  {teamData?.teamName}
                </h4>
                <div className="flex items-center justify-center gap-4 mb-6">
                  <span className="px-4 py-2 bg-[#EFCA4E]/10 rounded-full text-[#EFCA4E] font-medium">
                    {teamData?.rollNumber}
                  </span>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <p className="text-4xl font-mono font-bold bg-gradient-to-r from-white to-[#F6F1E2] bg-clip-text text-transparent tracking-wider">
                      {teamCode}
                    </p>
                  </div>
                      ...
                      >
                        ...
                        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                          <div className="flex items-center gap-4">
                            ...
                            <h4 className="text-2xl font-bold text-white group-hover:text-[#EFCA4E] transition-colors duration-300">
                              {Eventsday[event - 1].name}
                            </h4>
                          </div>
          ...
          >
            ...
            <div className="relative z-10 bg-black/10 rounded-xl p-6 backdrop-blur-sm">
              ...
              {activeTab === "create" && (
                ...
                >
                  {/* Create form content */}
                  {/* ... (rest of the create form content remains unchanged) ... */}
                </motion.div>
              )}
              ...
              {activeTab === "join" && (
                ...
                >
                  {/* Join form content */}
                  {/* ... (rest of the join form content remains unchanged) ... */}
                </motion.div>
              )}
            </div>
          </motion.div>
      ...
      >
        <div className="relative bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-[#EFCA4E]/20 text-left space-y-6 max-w-4xl mx-auto overflow-hidden">
          ...
          <motion.h2 
            initial={{ y: -20 }}
            animate={{ y: 0 }}
            className="relative text-4xl font-bold text-center"
          >
            <span className="bg-gradient-to-r from-[#EFCA4E] via-[#F6F1E2] to-[#EFCA4E] text-transparent bg-clip-text animate-gradient-x">
          ...
          >
            <p className="text-white text-lg font-bold">
              Teams are limited to a maximum of 8 participants
            </p>
          </motion.div>
          ...
          >
            ...
            <a 
              href="tel:9471828932" 
              className="inline-block text-yellow-400 hover:text-yellow-300 text-lg font-medium transition-colors duration-300"
            >
              WhatsApp: 9471828932
            </a>
            <p className="text-yellow-400/80 text-sm italic mt-2">
              (Note: Team modifications will only be considered in extreme cases, so please create your team carefully)
            </p>
          </motion.div>
          ...
          <div className="relative bg-white/5 backdrop-blur-md p-6 rounded-xl border border-[#EFCA4E]/30 space-y-6 shadow-xl hover:shadow-[#EFCA4E]/20 transition-all duration-300">
            <motion.h3 
              initial={{ x: -20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              className="text-3xl font-bold text-[#EFCA4E] mb-4"
            >
              General Rules
            </motion.h3>
            ...
            <motion.ul 
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              className="space-y-4 text-[#F6F1E2]/90"
            >
            ...
            <motion.h3 
              initial={{ x: -20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              className="text-3xl font-bold text-[#EFCA4E] mt-8 mb-4"
            >
              Joining a Team
            </motion.h3>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-2 pl-4">
                    ...
                    <li>• <span className="font-semibold text-red-400">Restriction:</span> Non-BIT students can only join day events, not night events</li>
                  </ul>
                </div>
              </li>
            </motion.ul>
          ...
          <motion.p 
            ...
            className="text-[#F6F1E2]/60 text-center text-lg italic mt-6"
          >
