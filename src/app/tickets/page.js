      ...
      <div className="relative pt-24 px-4 pb-16 max-w-7xl mx-auto">
              ...
              <div className="flex-1 space-y-8">
                <div>
                  ...
                  <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[#EFCA4E]/10 to-[#F6F1E2]/10 border border-[#EFCA4E]/20">
                    ...
                    <span className="text-[#F6F1E2] text-sm font-medium">
                      Premium Experience
                    </span>
                  </div>
                </div>
              ...
              <div className="flex-1">
                <div className="space-y-6">
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-[#EFCA4E]/10 to-transparent border border-[#EFCA4E]/20">
                    <div className="text-sm text-[#EFCA4E] mb-2">
                      Outside Students
                    </div>
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-[#F6F1E2]/10 to-transparent border border-[#F6F1E2]/20">
                    <div className="text-sm text-[#F6F1E2] mb-2">
                      BIT Mesra Students
                    </div>
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-[#F6F1E2]">
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {["Cultural Extravaganza", "Art & Innovation", "Grand Finale"].map(
              (day, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <p className="text-xl text-gray-400 leading-relaxed mb-12">
            Join us for an unforgettable celebration of talent, technology, and
            culture. Create memories that will last a lifetime at BIT
            Mesra&nbsp;s flagship festival.
          </p>
