...
export default function GalleryPage() {
  ...
  return (
    <div className="text-white p-20 md:p-10 lg:p-20 w-full overflow-hidden flex flex-col items-center bg-gradient-to-b from-black via-purple-900 to-black">
   <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 pb-4 text-center bg-gradient-to-r from-purple-400 to-orange-400 text-transparent bg-clip-text">
